...
<body>
        ...
        <div class="header">
            <header class="header_tit"> 
                ...
                <a href="/reservation/myreservation" class="btn_my">
                	<c:choose>
						<c:when test="${userMail eq null}">
							<span class="viewReservation" title="예약확인">예약확인</span>
						</c:when>
						<c:otherwise>
							<span class="viewReservation" title="예약확인">${userMail}</span>
						</c:otherwise>
					</c:choose>
                </a>
            </header>
    ...
    <li class="item" style="background-image: url(file/img/{imageFileId});">
        ...
        <li class="item">
            <a href="detail?id={id}" class="item_book">
                <div class="item_preview">
                    <img alt="{description}" class="img_thumb" src="file/img/{imageFileId}">
