    ...
    <div id="container">
        <div class="header fade">
            <header class="header_tit">
                <h1 class="logo">
                    ...
                    <a href="resources/htmls/myreservation.html" class="lnk_logo" title="예약"> <span class="spr_bi ico_bk_logo">예약</span> </a>
                </h1>
        ...
        <div class="ct main">
            <div>
                ...
                <div class="section_btn"> <button onClick="location.href='resources/htmls/reserve.html'" type="button" class="bk_btn"> <i class="fn fn-nbooking-calender2"></i> <span>예매하기</span> </button> </div>
